    ...
    <div class="recruiter-sec-main">
        <div class="recruiter-inner">
            <div class="row">
                ...
                @endphp
                <div class="col-md-4">
                    <!--<a href="{{ route('admin.recruter.detail',$post->id)}}">-->
                        <div class="recruiter-box-block-sec">
                            ...
                            <!--</div>-->
                                    ...
                                    <ul class="list-inline mb-0">
                                        ...
                                        <li class="list-inline-item">
                                            <a class="job-detail-icons" href="javascript:void(0)">
                                               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#787878" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
