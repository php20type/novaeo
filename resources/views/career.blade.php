                        ...
                        <div class="banner-box-block-inner">
                            <form method="get" action="{{ route('career')}}">
                                <div class="form-field">
                                    <input type="text" name="job_title" value="@if(isset($_REQUEST['job_title'])){{$_REQUEST['job_title']}} @endif" placeholder="Job Title or Keywords" />
                                </div>
                                <div class="form-field">
                            ...
                            <div class="position-box-content">
                                <div class="position-time-block">
                                    ...
                                    <div class="position-list-block">
                                        ...
                                        <a href="javascript:void(0)" onclick="jobDetail(`{{$job->title}}`,`{{$job->specification}}`,`{{$job->work_place}}`,`{{$job->experience}}`,`{{$job->schedule}}`,`{{$job->skill1}}`,`{{$job->skill2}}`,`{{$job->skill3}}`,`{{$job->employment_type}}`)">View Details</a>
                                            @if(!empty(Auth::user()))
...
<script>
    ...
    function jobDetail(title, specification, work_place, experience, schedule, skill1, skill2, skill3, employment_type) {
