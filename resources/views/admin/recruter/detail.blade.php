                                ...
                                <form method="post" action="{{ route('admin.recruter.update') }}">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <select name="experience" id="experience">
                                            <option value="Less than 1 year"
                                                @if ($recruter->experience == 'Less than 1 year') selected @endif>Less than 1 year</option>
                                            ...
                                            <option value="more than 5 years"
                                                @if ($recruter->experience == 'more than 5 years') selected @endif>more than 5 years
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-field">
                                        ...
                                        <input type="text" name="location" id="location"
                                            value="{{ $recruter->location }}" placeholder="" />
                                    </div>
                                    <div class="form-field">
                                        <label>Salary</label>
                                        <input type="text" name="salary" id="salary"
                                            value="{{ $recruter->salary }}" placeholder="" />
                                    </div>
                                    <div class="form-field">
                                        <label>Payout Type</label>
                                        <select name="payout" id="payout">
                                            <option value="Month" @if ($recruter->payout == 'Month') selected @endif>
                                                Monthly</option>
                                            <option value="Hour" @if ($recruter->payout == 'Hour') selected @endif>
                                                Hourly</option>
                                        </select>
                                    </div>
                                    <div class="form-field">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input type="text" name="employment_type" id="employment_type"
                                            value="{{ $recruter->employment_type }}" placeholder="" />
                                    </div>
                                    ...
                                    <div class="form-field">
                                        ...
                                        <select name="schedule" id="schedule">
                                            ...
                                            <option value="night-shift"
                                                @if ($recruter->work_place == 'night-shift') selected @endif>Night Shift</option>
                                            <option value="flexible-shift"
                                                @if ($recruter->work_place == 'flexible-shift') selected @endif>Flexible Shift</option>
                                        </select>
                                    </div>
