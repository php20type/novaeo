...
class CareerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $jobposts=RecruterJob::select('recruter_job.*',DB::raw('(select id from candidates where job_id=recruter_job.id AND user_id='.$user_id.') as candidate_id'))->where('recruter_job.vacancy','>',0);
        ...
        return view('career',compact('jobposts','cities','job_title','location'));
    }
}
