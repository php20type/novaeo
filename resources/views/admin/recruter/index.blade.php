                                    ...
                                    <li class="list-inline-item">
                                        <a class="job-detail-icons" href="javascript:void(0)">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="#787878" stroke-width="2"
                                            ...
                                            {{-- @foreach ($post->Candidate){
                                                {{ $data->job_id }}
                                            }
                                            @endforeach --}}
                                            <p>{{ $post->Candidate->count() }} <a href='{{ route("admin.candidate.index").'?job_id='.$post->id }}'>applicants<a></p>
                                        </a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a class="job-detail-icons" href="javascript:void(0)">
